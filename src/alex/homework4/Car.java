...
public class Car {
    ...
    public Car(String carBrand, int avgSpeed, int fuel) {
    ...
    public void kmPassed() {
        ...
        int km;
        km = fuel / consumption * 100;
        System.out.println("On " + fuel + " liters of fuel you will drive " + km +" km at an average speed "+ avgSpeed+"km/h");
    }
